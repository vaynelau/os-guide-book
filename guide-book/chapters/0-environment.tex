...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=8cm]{0-1.eps}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=8cm]{0-2.eps}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=15cm]{get-ubuntu-image.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=10cm]{virtualbox-startup.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=8cm]{virtualbox-dialog1.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=10cm]{virtualbox-dialog2.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=10cm]{ubuntu-install1.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=10cm]{ubuntu-install2.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=8cm]{ubuntu-install3.png}
