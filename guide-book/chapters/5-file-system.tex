...
典型的磁盘的基本结构如图\ref{lab5-pic-1.png}所示：

\begin{figure}[htbp]
  \centering
  \includegraphics[width=12cm]{lab5-pic-1.png}
  \caption{磁盘结构示意图}\label{lab5-pic-1.png}
\end{figure}
...
磁盘空间的基本布局如图\ref{lab5-pic-2.png}所示。

\begin{figure}[htbp]
  \centering
  \includegraphics[width=12cm]{lab5-pic-2.png}
  \caption{磁盘空间布局示意图}\label{lab5-pic-2.png}
\end{figure}
...
为了建立起磁盘地址空间和进程虚存地址空间之间的缓存映射，我们采用这样一种设计：结构如图\ref{lab5-pic-4.png}。

\begin{figure}[htbp]
  \centering
  \includegraphics[width=12cm]{lab5-pic-4.png}
  \caption{块缓存示意图}\label{lab5-pic-4.png}
\end{figure}
...
文件在磁盘上的组织形式如图\ref{lab5-pic-3.png}所示：

\begin{figure}[htbp]
  \centering
  \includegraphics[width=12cm]{lab5-pic-3.png}
  \caption{文件控制块}\label{lab5-pic-3.png}
\end{figure}
...
的磁盘块的指针。为了简化计算，我们不使用间接磁盘块的前十个指针。文件控制块的结构如图\ref{lab5-pic-3.png}。
